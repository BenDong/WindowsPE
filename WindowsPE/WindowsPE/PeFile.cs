...
namespace WindowsPE
{
    ...
    {
        public UInt32 Signature;  // 4 bytes
        public IMAGE_FILE_HEADER FileHeader;  // 20 bytes
        public IMAGE_OPTIONAL_HEADER OptionalHeader;  // 224 bytes

        public IMAGE_IMPORT_DESCRIPTOR(byte[] buff)
        {
            Signature = (0xffffffff & buff[0]) +
                        ((0xffffffff & buff[1]) << 8) +
                        ((0xffffffff & buff[2]) << 16) +
                        ((0xffffffff & buff[3]) << 24);
            FileHeader = new IMAGE_FILE_HEADER(buff);
            OptionalHeader = new IMAGE_OPTIONAL_HEADER(buff);
        }
    }
    ...
    struct IMAGE_OPTIONAL_HEADER
    {
        ...
        //offset = 24
        public IMAGE_OPTIONAL_HEADER(byte[] buff)
        {
            Magic = (UInt16)(((0xffff & buff[25]) << 8) + buff[24]);
            MajorLinkerVersion = buff[26];
            MinorLinkerVersion = buff[27];
            SizeOfCode = (0xffffffff & buff[28]) +
                         ((0xffffffff & buff[29]) << 8) +
                         ((0xffffffff & buff[30]) << 16) +
                         ((0xffffffff & buff[31]) << 24);
            SizeOfInitializedData = (0xffffffff & buff[32]) +
                         ((0xffffffff & buff[33]) << 8) +
                         ((0xffffffff & buff[34]) << 16) +
                         ((0xffffffff & buff[35]) << 24);
            SizeOfUninitializedData = (0xffffffff & buff[36]) +
                         ((0xffffffff & buff[37]) << 8) +
                         ((0xffffffff & buff[38]) << 16) +
                         ((0xffffffff & buff[39]) << 24);
            AddressOfEntryPoint = (0xffffffff & buff[40]) +
                         ((0xffffffff & buff[41]) << 8) +
                         ((0xffffffff & buff[42]) << 16) +
                         ((0xffffffff & buff[43]) << 24);
            BaseOfCode = (0xffffffff & buff[44]) +
                         ((0xffffffff & buff[45]) << 8) +
                         ((0xffffffff & buff[46]) << 16) +
                         ((0xffffffff & buff[47]) << 24);
            BaseOfData = (0xffffffff & buff[48]) +
                         ((0xffffffff & buff[49]) << 8) +
                         ((0xffffffff & buff[50]) << 16) +
                         ((0xffffffff & buff[51]) << 24);
            ImageBase = (0xffffffff & buff[52]) +
                         ((0xffffffff & buff[53]) << 8) +
                         ((0xffffffff & buff[54]) << 16) +
                         ((0xffffffff & buff[55]) << 24);
            SectionAlignment = (0xffffffff & buff[56]) +
                         ((0xffffffff & buff[57]) << 8) +
                         ((0xffffffff & buff[58]) << 16) +
                         ((0xffffffff & buff[59]) << 24);
            FileAlignment = (0xffffffff & buff[60]) +
                         ((0xffffffff & buff[61]) << 8) +
                         ((0xffffffff & buff[62]) << 16) +
                         ((0xffffffff & buff[63]) << 24);
            MajorOperatingSystemVersion = (UInt16)(((0xffff & buff[65]) << 8) + buff[64]);
            MinorOperatingSystemVersion = (UInt16)(((0xffff & buff[67]) << 8) + buff[66]);
            MajorImageVersion = (UInt16)(((0xffff & buff[69]) << 8) + buff[68]);
            MinorImageVersion = (UInt16)(((0xffff & buff[71]) << 8) + buff[70]);
            MajorSubsystemVersion = (UInt16)(((0xffff & buff[73]) << 8) + buff[72]);
            MinorSubsystemVersion = (UInt16)(((0xffff & buff[75]) << 8) + buff[74]);
            Win32VersionValue = (0xffffffff & buff[76]) +
                         ((0xffffffff & buff[77]) << 8) +
                         ((0xffffffff & buff[78]) << 16) +
                         ((0xffffffff & buff[79]) << 24);
            SizeOfImage = (0xffffffff & buff[80]) +
                        ((0xffffffff & buff[81]) << 8) +
                        ((0xffffffff & buff[82]) << 16) +
                        ((0xffffffff & buff[83]) << 24);
            SizeOfHeaders = (0xffffffff & buff[84]) +
                        ((0xffffffff & buff[85]) << 8) +
                        ((0xffffffff & buff[86]) << 16) +
                        ((0xffffffff & buff[87]) << 24);
            CheckSum = (0xffffffff & buff[88]) +
                        ((0xffffffff & buff[89]) << 8) +
                        ((0xffffffff & buff[90]) << 16) +
                        ((0xffffffff & buff[91]) << 24);
            Subsystem = (UInt16)(((0xffff & buff[93]) << 8) + buff[92]);
            DllCharacteristics = (UInt16)(((0xffff & buff[95]) << 8) + buff[94]);
            SizeOfStackReserve = (0xffffffff & buff[96]) +
                        ((0xffffffff & buff[97]) << 8) +
                        ((0xffffffff & buff[98]) << 16) +
                        ((0xffffffff & buff[99]) << 24);
            SizeOfStackCommit = (0xffffffff & buff[100]) +
                        ((0xffffffff & buff[101]) << 8) +
                        ((0xffffffff & buff[102]) << 16) +
                        ((0xffffffff & buff[103]) << 24);
            SizeOfHeapReserve = (0xffffffff & buff[104]) +
                        ((0xffffffff & buff[105]) << 8) +
                        ((0xffffffff & buff[106]) << 16) +
                        ((0xffffffff & buff[107]) << 24);
            SizeOfHeapCommit = (0xffffffff & buff[108]) +
                        ((0xffffffff & buff[109]) << 8) +
                        ((0xffffffff & buff[110]) << 16) +
                        ((0xffffffff & buff[111]) << 24);
            LoaderFlags = (0xffffffff & buff[112]) +
                        ((0xffffffff & buff[113]) << 8) +
                        ((0xffffffff & buff[114]) << 16) +
                        ((0xffffffff & buff[115]) << 24);
            NumberOfRvaAndSizes = (0xffffffff & buff[116]) +
                        ((0xffffffff & buff[117]) << 8) +
                        ((0xffffffff & buff[118]) << 16) +
                        ((0xffffffff & buff[119]) << 24);
    ...
    struct IMAGE_FILE_HEADER
    {
        ...
        //offset = 4
        public IMAGE_FILE_HEADER(byte[] buff)
        {
            Machine = (UInt16)(((0xffff & buff[5]) << 8) + buff[4]);
            NumberOfSections = (UInt16)(((0xffff & buff[7]) << 8) + buff[6]);
            TimeDateStamp = (0xffffffff & buff[8]) +
                            ((0xffffffff & buff[9]) << 8) +
                            ((0xffffffff & buff[10]) << 16) +
                            ((0xffffffff & buff[11]) << 24);
            PointerToSymbolTable = (0xffffffff & buff[12]) +
                                   ((0xffffffff & buff[13]) << 8) +
                                   ((0xffffffff & buff[14]) << 16) +
                                   ((0xffffffff & buff[15]) << 24);
            NumberOfSymbols = (0xffffffff & buff[16]) +
                              ((0xffffffff & buff[17]) << 8) +
                              ((0xffffffff & buff[18]) << 16) +
                              ((0xffffffff & buff[19]) << 24);

            SizeOfOptionalHeader = (UInt16)(((0xffff & buff[21]) << 8) + buff[20]);
            Characteristics = (UInt16)(((0xffff & buff[23]) << 8) + buff[22]);
        }
    }
